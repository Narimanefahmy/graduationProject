   ...
   componentDidMount(){
    ...
    render() {
      ...
      <form onSubmit={this.handleSubmit}>
           ...
           <div className="input-container">
        <label>email </label>
          <input type="text2" value={this.state.name} name="email"  onChange={evt => this.updateInputValue(evt)}/> 
       
          
       </div>
          <div className="input-container">
        <label>Password </label>
        {/* <input type="password" value={this.state.name} name="password" onChange={this.handleChange} /> */}
