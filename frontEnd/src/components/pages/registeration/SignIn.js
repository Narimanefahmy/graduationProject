        ...
        <form className="form" >
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="input-container" >
              <div className="input-container">
                <label>email </label>
                <input type="text2" name="email" value={this.state.email} onChange={(e) => this.setState({ email: e.target.value })} />


              </div>
              <div className="input-container">
                <label>Password </label>
                <input type="password" value={this.state.name} name="password" onChange={(e) => this.setState({ password: e.target.value })} />
          ...
          <div className="button-container">
            <input type="button" value="Sign in" onClick={() => this.fetchData()} />
          </div>
